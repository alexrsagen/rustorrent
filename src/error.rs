...
pub enum Error {
	...
	PeerIdInvalid,
	InfoHashInvalid,
	PieceHashInvalid { piece_index: usize },
	MessageHandled,
	MessageIdInvalid,
	...
	UnsolicitedPieceBlockMessage { piece_index: usize, block_index: usize },
	InvalidPieceBlockMessage { piece_index: usize, block_index: usize },
	NotConnected,
	NoData,
	InvalidCommand,
	PeerChoking,
...
impl std::fmt::Display for Error {
	fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
		match self {
			...
			Error::ValueTypeMissingOrInvalid(value) => write!(f, "value {:?} missing or has invalid type", value),
...
impl From<crate::bencode::Error> for Error { fn from(e: crate::bencode::Error) -> Self { Self::Bencode(e) } }
impl From<hyper::Error> for Error { fn from(e: hyper::Error) -> Self { Self::Hyper(e) } }
impl From<hyper::http::Error> for Error { fn from(e: hyper::http::Error) -> Self { Self::Http(e) } }
impl From<std::string::FromUtf8Error> for Error { fn from(e: std::string::FromUtf8Error) -> Self { Self::Utf8Invalid(e) } }
